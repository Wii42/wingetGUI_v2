...
class GenericTableScanner extends TableScanner{
  GenericTableScanner(super.respList, {required super.command});
  ...
  @override
  TablePart tablePart(List<String> tableLines, AppLocalizations locale) => GenericTablePart(tableLines, command: command, locale: locale);
