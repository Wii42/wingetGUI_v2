...
extension SettingQueryWhere on QueryBuilder<Setting, Setting, QWhereClause> {
  ...
  QueryBuilder<Setting, Setting, QAfterWhereClause> keyGreaterThan(
    String key, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Setting, Setting, QAfterWhereClause> keyLessThan(
    String key, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Setting, Setting, QAfterWhereClause> keyBetween(
    String lowerKey,
    String upperKey, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Setting, Setting, QAfterWhereClause> keyStartsWith(
      String KeyPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'key',
  ...
  QueryBuilder<Setting, Setting, QAfterWhereClause> keyIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'key',
        value: [''],
  ...
  QueryBuilder<Setting, Setting, QAfterWhereClause> keyIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
